...
const captureChart = () => {
    ...
    chart = document.getElementById('graf_reg_local');

    html2canvas(chart, {
        useCORS: true,
        allowTaint: true
    }).then(canvas => {
        props.form.graf_reg_local = canvas.toDataURL('image/png');
...
<template>
    ...
    <div class="row mb-4">
        <div class="col">
            <textarea class="form-control" v-model="form.ocorr_por_local" rows="5"></textarea>
        </div>
    </div>
    <div class="row mb-4">
