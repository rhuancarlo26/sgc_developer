...
const excluirRelatorio = (item) => {
    router.delete(route('contratos.contratada.servicos.pmqa.relatorio.delete', {
                    ...
                    <template #body="{ item }">
                        <tr>
                            ...
                            <td class="text-center">
                                <span v-if="item.fk_status === 1" class="badge bg-azure-lt">
                                    Em confecção
                                </span>
                                ...
                                <span v-else-if="item.fk_status === 4" class="badge bg-blue-lt">
                                    Pendente
                                </span>
                            </td>
                            <td>
                                ...
                                <div class="dropdown-menu dropdown-menu-end" style="">
                                    ...
                                    <a @click="abrirVisualizarRelatorio(item)" class="dropdown-item"
