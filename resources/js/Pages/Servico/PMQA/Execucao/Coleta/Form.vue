...
const saveColetaPonto = () => {
    if (form.id) {
        form.patch(route('contratos.contratada.servicos.pmqa.execucao.coleta.update', {
        ...
        form.post(route('contratos.contratada.servicos.pmqa.execucao.coleta.store', {
            contrato: props.contrato.id,
            servico: props.servico.id,
            campanha: props.campanha.id
        }));
...
const saveArquivo = () => {
    ...
    form.post(route('contratos.contratada.servicos.pmqa.execucao.coleta.store_arquivo', {
        contrato: props.contrato.id,
        servico: props.servico.id,
        campanha: props.campanha.id
    }))
            ...
            <template #body>
                <div class="row mb-4">
                    <div class="col form-group">
                        ...
                        <input type="date" class="form-control" name="dt_coleta" id="dt_coleta"
                ...
                <div v-if="form.coleta === false">
                    ...
                    <div class="row">
                        <div class="col form-group">
                            ...
                            <input type="text" class="form-control" name="acondicionamento_amostra"
