			...
			<div v-if="Object.keys(data).length > 0">
				<div class="row row-gap-2">
					...
					<div class="col-6 mb-4 row row-gap-2">
						...
						<div v-if="data.licenca.segmentos?.length" class="col-12">
							<label>UF/KM final: <b>{{ data.licenca.segmentos[data.licenca.segmentos.length -
								1].uf_final}}/{{ data.licenca.segmentos[data.licenca.segmentos.length - 1].km_fim }}</b></label>
						</div>
						<div class="col-12">
