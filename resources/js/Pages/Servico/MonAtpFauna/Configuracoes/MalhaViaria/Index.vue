...
<template>
    ...
    <AuthenticatedLayout>
        ...
        <Navbar :contrato="contrato" :servico="servico">
            <template #body>
                <ModelSearchFormAllColumns :columns="[]">
                    <template #action>
                        <NavButton v-if="data.data?.length" @click="modalEnviarFiscal" type-button="info" title="Submeter ao fiscal"/>
                    </template>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="dropdown-menu dropdown-menu-end">
                                    <a v-if="item.arquivo_licenca" @click="openArquivoLicenca(item)" href="javascript:void(0);" class="dropdown-item">
                                        Visualizar
                                    </a>
                                    <a @click="modalAdicionaShapeFile(item)" href="javascript:void(0);" class="dropdown-item">
                                        Adicionar Shapefile
                                    </a>
                                    <a @click="abrirModalVisualizarMalhaViaria(item)" href="javascript:void(0);" class="dropdown-item">
        ...
        <LinkConfirmation ref="linkConfirmationRef" :options="{ text: 'Deseja realmente enviar a configuração para o fiscal?' }" />
