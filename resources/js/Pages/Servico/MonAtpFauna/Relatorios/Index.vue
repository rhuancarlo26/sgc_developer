<!-- resources\js\Pages\Servico\MonAtpFauna\Relatorios\Index.vue -->
<script setup>
...
const abrirModalNovoRelatorio = () => {
  modalNovoRelatorio.value.abrirModal();
}
...
<template>
  ...
  <AuthenticatedLayout>
    ...
    <ModalNovoRelatorio ref="modalNovoRelatorio" />
