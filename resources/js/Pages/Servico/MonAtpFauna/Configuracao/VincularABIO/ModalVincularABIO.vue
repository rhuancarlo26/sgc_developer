...
const getLicenca = () => {
  axios.get(route('contratos.contratada.servicos.mon_atp_fauna.configuracao.vincular_abio.get_licenca', { contrato: props.contrato.id, servico: props.servico.id, licenca: numero_licenca.value.id })).then(r => {
    licenca.value = r.data;
  });
}

const vincularABIO = () => {
  router.post(route('contratos.contratada.servicos.mon_atp_fauna.configuracao.vincular_abio.store', { contrato: props.contrato.id, servico: props.servico.id }), { licenca_id: licenca.value.id }, {
