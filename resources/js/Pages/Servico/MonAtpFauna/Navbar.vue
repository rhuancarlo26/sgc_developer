            ...
            <div class="navbar">
              <div class="container-xl">
                <div class="row flex-fill align-items-center">
                  <div class="col">
                    <ul class="navbar-nav">
                      <NavDropdown prefix="contratos.contratada.servicos.mon_atp_fauna.configuracao*"
                        title="Configurações" :icon="IconLayoutDashboard">

                        <NavDropdownLink
                          route-name="contratos.contratada.servicos.mon_atp_fauna.configuracao.vincular_abio.index"
                          active-on-route-prefix="contratos.contratada.servicos.mon_atp_fauna.configuracao.vincular_abio*"
