...
const vincularASV = (licenca, servico) => {
    router.post(route('contratos.contratada.servicos.afugentamento.resgate.fauna.configuracao.vincular.asv.create', { licenca: licenca, servico: servico }));
};
...
<template>
    ...
    <Modal ref="modalRef" title="VIncular ASV" modal-dialog-class="modal-xl">
        <template #body>
            <div class="card">
                <div class="card-body">
                    <div class="d-flex">
        ...
        <template #footer>
            <div class="">
                <button type="button" class="btn btn-success" @click="vincularASV(licenca, servico)" data-dismiss="modal"
                    aria-label="vincular asv">
                    Vincular ASV
                </button>
            </div>
        </template>
