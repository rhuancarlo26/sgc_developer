...
const vincularRET = (licenca) => {
    // router.post(route('rota para o RET'));
};
...
<template>
    ...
    <Modal ref="modalRef" title="VIncular RET" modal-dialog-class="modal-xl">
        <template #body>
            <div class="card">
                <div class="card-body">
                    <div class="card-header mb-4">
                        <span>Dados de ABIO</span>
                    </div>
                    <div class="d-flex">
                        <div class="col-md-6">
                            <div class="mb-2">
        ...
        <template #footer>
            <div class="">
                <button type="button" class="btn btn-success" @click="vincularRET(licenca)" data-dismiss="modal"
