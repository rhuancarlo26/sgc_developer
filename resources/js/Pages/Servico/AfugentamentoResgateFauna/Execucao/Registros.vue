		...
		<template #header>
			<div class="w-100 d-flex justify-content-between">
				<Breadcrumb class="align-self-center" :links="[
					...
					" />
				<div>
					<Link class="btn" :href="route('contratos.contratada.servicos.index', { contrato: props.contrato.id })">
					Voltar
					</Link>
				</div>
			</div>
						...
						<tr>
							...
							<td>
								...
								<ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
									<li>
										<a class="dropdown-item" @click="abrirModalVisualizarRegistro(item)" href="javascript:void(0);">
											Visualizar
										</a>
									</li>
									<li>
										<a class="dropdown-item" @click="abrirModalEditarRegistro(item)" href="javascript:void(0);">
											Editar
										</a>
									</li>
									<li>
