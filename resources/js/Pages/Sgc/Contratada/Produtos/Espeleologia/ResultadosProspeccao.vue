<template>
  <div>
    <h3>Resultados (Prospecção) - Visualização de Shapefiles</h3>
    ...
    <div class="tab-content">
      ...
      >
        <div class="mb-5">
          ...
          <div v-if="tipo === 'extensao_rodovia_prospectada'">
            <div class="mb-3">
                <!-- Definição de campos para Extensão da Rodovia Prospeccionada -->
                 <div class="form-number">
                    <label class="form-label">Quantidade de Rodovia Prospeccionada (km)</label>
                    <input
                      type="number"
                      class="form-control"
                      v-model="rodovia.extensao"
                    />
                 </div>
                 <div class="form-text">
...
const activeSubTab = ref('feicoes')
