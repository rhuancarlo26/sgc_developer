        ...
        <div class="mb-4">
          ...
          <div class="row mb-4">
            <div class="col d-flex justify-content-end">
              <NavButton type="button" type-button="success" title="Adicionar Módulo" @click="handleAdicionarModulo" />
            </div>
          </div>
              ...
              <template #body="{ item }">
                <tr>
                  ...
                  <td class="text-center" style="min-width: 150px;">
                    <NavButton @click="editModulo(item)" type-button="primary" title="Editar" class="me-2">
