            ...
            <template #body>
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="mb-3 text-center"><span class="badge text-white" :class="{
                            'bg-warning': campanha.status === 'Em análise',
                        ...
                        <div class="tab-content">
                            ...
                            <div v-if="activeTab === 'apresentacao'" class="tab-pane fade show active">
                                ...
                                <!-- SubStep 2: Dados gerais (ABIOs, Profissionais, datas) -->
