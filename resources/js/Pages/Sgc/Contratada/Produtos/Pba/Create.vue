...
const props = defineProps({
    ...
    produto: { type: String, default: 'PBA' },
...
const salvarRascunho = () => {
    console.log('Pba: salvarRascunho chamado', form);
    ...
    if (CardFotosRef.value?.validarCampos?.()) {
        console.log('Pba: validação de fotos falhou');
        return;
    }

    if (CardAnexosRef.value?.validarCampos?.()) {
        console.log('Pba: validação de anexos falhou');
        return;
    }
...
const enviarParaAnalise = () => {
    console.log('Pba: enviarParaAnalise chamado', form);
...
const submitForm = () => {
    ...
    console.log('Pba: submitForm', { url, form });
    ...
    form.post(url, {
        ...
        forceFormData: true,
        onSuccess: () => {
            console.log('Pba: form enviado com sucesso');
        ...
        onError: (errors) => {
            console.log('Pba: erros do post', errors);
        },
    });
};
