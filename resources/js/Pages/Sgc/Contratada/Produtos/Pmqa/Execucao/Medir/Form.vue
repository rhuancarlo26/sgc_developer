...
const saveMedicao = () => {
    ...
    if (form.id) {
        form.patch(
            route("contratos.contratada.sgc.pmqa.execucao.medir.update", {
        ...
        form.post(
            route("contratos.contratada.sgc.pmqa.execucao.medir.store", {
                contrato: props.contrato.id,
                produto: props.produto,
                pmqa: props.pmqa.id,
                campanha: props.campanha.id,
...
const saveArquivo = () => {
    ...
    form.post(
        route(
            "contratos.contratada.servicos.pmqa.execucao.medir.store_arquivo",
            {
                contrato: props.contrato.id,
                ...
                <div class="col d-flex align-self-end">
                    <label class="form-check">
                        ...
                        <span class="form-check-label"
                            >Não foi possível realizar a medição</span
                        >
                    </label>
                ...
                <div class="table-responsive">
                    <table class="table card-table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr
                                v-for="vinculado in ponto.ponto?.lista
            ...
            <div v-if="ponto.medicao?.id && !form.medido">
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <div
                            v-if="ponto.medicao?.arquivos?.length"
                        ...
                        >
                            <table class="table table-hover non-hover">
                                ...
                                <tbody>
                                    <tr
                                        v-for="arquivo in ponto.medicao
                                            .arquivos"
                                        :key="arquivo.id"
                                    >
                                        <td>{{ arquivo.nome }}</td>
