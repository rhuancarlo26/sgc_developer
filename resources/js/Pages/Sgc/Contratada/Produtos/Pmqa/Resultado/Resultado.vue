...
onMounted(() => {
    if (props.resultado.analises.length) {
        props.resultado.analises.forEach(analise => {
            form.analises[analise.parametro_id] = analise.analise_parametro;
        });
    }
});
    ...
    <template #resultados>
      <div class="card-header">
        <ul class="nav nav-tabs card-header-tabs" data-bs-toggle="tabs" role="tablist">
          <li
            v-for="parametro in uniqueParametros"
            :key="parametro.id"
            class="nav-item"
            role="presentation"
          >
            <a
              :href="'#tabs-parametro-' + parametro.id"
              class="nav-link"
              data-bs-toggle="tab"
              aria-selected="false"
              tabindex="-1"
            ...
            >
              {{
                `${parametro.parametro}${parametro.unidade ? ` - ${parametro.unidade}` : ''}`
              }}
            </a>
          </li>
          ...
          <li class="nav-item" role="presentation">
            <a
              href="#tabs-parametro-outra-analise"
              class="nav-link"
              data-bs-toggle="tab"
              aria-selected="false"
              tabindex="-1"
      ...
      <div class="card-body">
        <div class="tab-content">
          <div
            ...
            :name="'tabs-parametro-' + parametro.id"
            class="tab-pane"
            role="tabpanel"
          >
            <div
          ...
          <div class="tab-pane" id="tabs-parametro-outra-analise" role="tabpanel">
            <div>
              ...
              <div class="row mb-4">
                <div class="col form-group d-flex justify-content-end">
                  <NavButton
                    v-if="form_outra_analise.id"
                    @click="reset_form_outra_analise()"
                    type-button="danger"
                    :icon="IconX"
                  />
                  <NavButton
                    ...
                    type-button="success"
                    :icon="IconDeviceFloppy"
                    :title="form_outra_analise.id ? 'Editar' : 'Salvar'"
                  />
                </div>
              </div>
                ...
                <div class="col">
                  <div class="table-responsive">
                    <table class="table table-hover non-hover">
                      ...
                      <tbody>
                        <tr
                          v-for="outraAnalise in resultado.outras_analises"
                          :key="outraAnalise.id"
                        >
