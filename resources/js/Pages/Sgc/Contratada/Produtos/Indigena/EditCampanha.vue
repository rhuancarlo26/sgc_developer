...
const submitForm = () => {
    const rotaAtualizacao = props.produto?.toLowerCase() === 'indigena'
        ? 'sgc.contratada.produtos.indigena.update'
            ...
            <div class="flex-fill content-column">
                <div class="card mb-3">
                    <div class="card-body text-center py-3">
                        <h2 class="mb-1">EDITAR CAMPANHA INDÍGENA</h2>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select v-if="props.produto?.toLowerCase() === 'indigena'" v-model="form.subproduto" class="form-select" required>
