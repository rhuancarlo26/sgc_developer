...
const props = defineProps({
    ...
    produto: { type: String, default: 'Indigena' },
...
const salvarRascunho = () => {
    console.log('Indigena: salvarRascunho chamado', form);
    ...
    if (CardFotosRef.value?.validarCampos?.()) {
        console.log('Indigena: validação de fotos falhou');
        return;
    }

    if (CardAnexosRef.value?.validarCampos?.()) {
        console.log('Indigena: validação de anexos falhou');
        return;
    }
...
const enviarParaAnalise = () => {
    console.log('Indigena: enviarParaAnalise chamado', form);
...
const submitForm = () => {
    ...
    console.log('Indigena: submitForm', { url, form });
    ...
    form.post(url, {
        ...
        forceFormData: true,
        onSuccess: () => {
            console.log('Indigena: form enviado com sucesso');
        ...
        onError: (errors) => {
            console.log('Indigena: erros do post', errors);
        },
    });
};
