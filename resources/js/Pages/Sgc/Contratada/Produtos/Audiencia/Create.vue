...
const props = defineProps({
    ...
    produto: { type: String, default: 'Audiencia' },
...
const salvarRascunho = () => {
    console.log('Audiencia: salvarRascunho chamado', form);
    ...
    if (CardFotosRef.value?.validarCampos?.()) {
        console.log('Audiencia: validação de fotos falhou');
        return;
    }

    if (CardAnexosRef.value?.validarCampos?.()) {
        console.log('Audiencia: validação de anexos falhou');
        return;
    }
...
const enviarParaAnalise = () => {
    console.log('Audiencia: enviarParaAnalise chamado', form);
...
const submitForm = () => {
    ...
    console.log('Audiencia: submitForm', { url, form });
    ...
    form.post(url, {
        ...
        forceFormData: true,
        onSuccess: () => {
            console.log('Audiencia: form enviado com sucesso');
        ...
        onError: (errors) => {
            console.log('Audiencia: erros do post', errors);
        },
    });
};
