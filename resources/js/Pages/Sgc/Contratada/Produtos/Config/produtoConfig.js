...
export const produtoConfig = {
  ...
  espeleologia: {
    ...
    rotaNome: {
      index: 'sgc.contratada.produtos.index',
      create: 'sgc.contratada.produtos.create',
      show: 'sgc.contratada.produtos.espeleo.show',
      analise: 'sgc.contratada.produtos.espeleo.analise',
      edit: 'sgc.contratada.produtos.espeleo.show',
      destroy: 'sgc.contratada.produtos.destroy',
      aprovarTudo: 'sgc.contratada.produtos.espeleo.aprovarTudo',
      reprovarTudo: 'sgc.contratada.produtos.espeleo.reprovarTudo',
      arquivar: null,
      restaurar: null,
    }
  },
