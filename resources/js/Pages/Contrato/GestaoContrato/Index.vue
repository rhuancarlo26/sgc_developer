        ...
        <div class="card">
          ...
          <div class="card-body">
            <div class="row mb-4">
              ...
              <span class="col"><strong>Número do Contrato: </strong>{{ contratoClicado.numero_contrato }}</span>
            </div>
            <div class="row mb-4">
              <span class="col"><strong>Objeto do Contrato: </strong>{{ contratoClicado.objeto }}</span>
            </div>
            <div class="row mb-4">
              <span class="col"><strong>Número do Processo (DNIT): </strong>{{ contratoClicado.processo_sei }}</span>
              <span class="col"><strong>Início da Vigência: </strong>{{
                dateTimeFormat(contratoClicado.data_inicio_vigencia ?? null, { dateStyle: 'short', timeStyle: 'short' })
              }}</span>
          ...
          <div class="card-body">
            <div class="row">
              ...
              <span class="col"><strong>Tipo de Licitação: </strong>{{ contratoClicado.tipo_licitacao }}</span>
          ...
          <div class="card-body">
            <div class="row">
              ...
              <span class="col"><strong>Fiscal do Contrato: </strong>{{ contratoClicado.fiscal_contrato }}</span>
            </div>
          </div>
