                            ...
                            <form @submit.prevent="salvarContrato()" :disabled="form.processing">
                                ...
                                <div class="card-body">
                                    <div class="row mb-4">
                                        <div class="col">
                                            ...
                                            <div class="row g-2">
                                                ...
                                                <div class="col-auto">
                                                    <button @click="getDadosContrato()" type="button"
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col">
                                            ...
                                            <input type="text" id="contratada" name="contratada" class="form-control"
                                                v-model="form.contratada" disabled />
                                    ...
                                    <div class="row mb-4">
                                        <div class="col">
                                            ...
                                            <textarea name="objeto" id="objeto" class="form-control" rows="5"
                                                v-model="form.objeto" disabled></textarea>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            ...
                                            <input type="date" id="data_inicio_vigencia" name="data_inicio_vigencia"
                                                class="form-control" v-model="form.data_inicio_vigencia" disabled />
                                            <InputError :message="form.errors.data_inicio_vigencia" />
                                        </div>
                                        <div class="col">
                                            <InputLabel value="Término da Vigência" for="data_termino_vigencia" />
                                            <input type="date" id="data_termino_vigencia" name="data_termino_vigencia"
                                                class="form-control" v-model="form.data_termino_vigencia" disabled />
                                        ...
                                        <div class="col">
                                            ...
                                            <input type="text" id="situacao" name="situacao" class="form-control"
                                                v-model="form.situacao" disabled />
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <input type="text" id="edital" name="edital" class="form-control"
                                                v-model="form.edital" disabled />
                                            <InputError :message="form.errors.edital" />
                                        </div>
                                        <div class="col">
                                            <InputLabel value="Tipo de Licitação" for="tipo_licitacao" />
                                            <input type="text" id="tipo_licitacao" name="tipo_licitacao"
                                                class="form-control" v-model="form.tipo_licitacao" disabled />
                                        ...
                                        <div class="col">
                                            ...
                                            <input type="text" id="modalidade" name="modalidade" class="form-control"
                                                v-model="form.modalidade" disabled />
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <input type="text" id="unidade_gestora" name="unidade_gestora"
                                                class="form-control" v-model="form.unidade_gestora" disabled />
                                            <InputError :message="form.errors.unidade_gestora" />
                                        </div>
                                        <div class="col">
                                            <InputLabel value="Fiscal do Contrato" for="fiscal_contrato" />
                                            <input type="text" id="fiscal_contrato" name="fiscal_contrato"
                                                class="form-control" v-model="form.fiscal_contrato" disabled />
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <input type="text" id="snv" name="snv" class="form-control"
                                                v-model="form.snv" />
                                        ...
                                        <div class="col">
                                            ...
                                            <input type="text" id="total_reajuste" name="total_reajuste"
                                                class="form-control" v-model="form.total_reajuste" disabled />
                                ...
                                <div class="card-body">
                                    <div class="d-flex justify-content-end">
                                        <button @click="salvarContrato()" type="button" class="btn btn-success"
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                ...
                                                <v-select :options="uf_rodovias" label="rodovia"
                                            ...
                                            <div class="col">
                                                ...
                                                <input type="number" step="any" id="km_inicial" name="km_inicial"
                                                    class="form-control" v-model="form_trecho.km_inicial" />
                                                <InputError :message="form_trecho.errors.km_inicial" />
                                            </div>
                                            <div class="col">
                                                <InputLabel value="Km Final" for="km_final" />
                                                <input type="number" step="any" id="km_final" name="km_final"
                                                    class="form-control" v-model="form_trecho.km_final" />
                                            ...
                                            <div class="col">
                                                ...
                                                <div class="row g-2">
                                                    <div class="col">
                                                        <select name="trecho_tipo" id="trecho_tipo"
                                                    ...
                                                    <div v-if="form_trecho.id" class="col-auto">
                                                        <button @click="form_trecho.reset()" type="button"
                                ...
                                <div class="card-body">
                                    <div class="table-responsive mb-4">
                                        <table class="table card-table table-bordered table-hover">
                                            ...
                                            <tbody>
                                                <tr v-for="trecho in contrato.trechos" :key="trecho.id"
                                                    ...
                                                    <td class="w-1">
                                                        <div class="d-flex">
                                                            ...
                                                            <button @click="editarTrecho(trecho)" type="button"
                                                            ...
                                                            <LinkConfirmation v-slot="confirmation"
                                                                ...
                                                                <Link :onBefore="confirmation.show"
                                                                    :href="route('contratos.gestao.delete_trecho', [tipo.id, trecho.id])"
