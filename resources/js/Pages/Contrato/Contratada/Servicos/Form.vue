                ...
                <div class="card-header">
                    <ul class="nav nav-tabs card-header-tabs" data-bs-toggle="tabs" role="tablist">
                        <li class="nav-item" role="presentation">
                            <a href="#dadosGerais" class="nav-link active" data-bs-toggle="tab" aria-selected="true"
                                role="tab">Dados
                                gerais</a>
                        </li>
                        <template v-if="servico.id">
                            <li class="nav-item" role="presentation">
                                <a href="#vincularRecursos" class="nav-link" data-bs-toggle="tab" aria-selected="false"
                                    role="tab" tabindex="-1">Vincular recursos</a>
                            </li>
                            <li class="nav-item" role="presentation">
                                <a href="#vincularCondicionantes" class="nav-link" data-bs-toggle="tab"
                                    aria-selected="false" role="tab" tabindex="-1">Vincular condicionantes</a>
                            </li>
                        </template>
                    </ul>
                </div>
                <div class="card-body">
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="vincularRecursos" role="tabpanel">
                            <TabVincularRecursos :servico="servico" :rhs="rhs" :veiculos="veiculos"
