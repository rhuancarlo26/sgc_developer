...
const destroyDocumentoEquipamento = (documento_id) => {
    router.delete(route('contratos.contratada.recurso.equipamento.destroy', {
                ...
                <form @submit.prevent="salvarEquipamento()">
                    <div class="row mb-4">
                        ...
                        <div class="col">
                            ...
                            <input id="descricao" name="descricao" v-model="form.modelo" class="form-control"/>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-2">
                            ...
                            <input type="date" id="ultima_calibracao" name="ultima_calibracao"
                                   v-model="form.ultima_calibracao"
                                   class="form-control"/>
                    ...
                    <div class="row mb-4">
                        <div class="col">
                            ...
                            <textarea id="atividade" name="atividade" v-model="form.espec_tecnica" class="form-control"
                                      rows="5"></textarea>
                            <InputError :message="form.errors.espec_tecnica"/>
                        </div>
                        <div class="col">
                    ...
                    <div class="row mb-4">
                        <div class="col">
                            ...
                            <div class="row g-2">
                                ...
                                <div class="col-auto">
                                    <a @click="salvarDocumentoEquipamento()" href="javascript:void(0)"
