                ...
                <ul class="nav nav-tabs card-header-tabs nav-fill" data-bs-toggle="tabs" role="tablist">
                    <li class="nav-item" role="presentation" @click="visualizarMapa">
                        <NavLinkVoid title="Dados contratuais" :icon="IconCircleCheck" tabName="dadosContratuais"
                                     ...
                                     class="nav-link active d-flex justify-content-between" data-bs-toggle="tab"
                                     aria-selected="true"
                                     role="tab"/>
                    </li>
                    <li class="nav-item" role="presentation">
                        <NavLinkVoid title="Introdução" :icon="contrato.introducao ? IconCircleCheck : IconCircleX"
                                     :iconClass="contrato.introducao ? 'text-success' : 'text-danger'"
                                     tabName="introducao"
                                     @switch-tab="switchTab" class="nav-link active d-flex justify-content-between"
                                     data-bs-toggle="tab"
                    ...
                    <li class="nav-item" role="presentation">
                        <NavLinkVoid title="Licenciamento"
                                     :icon="contrato.licenciamentos.length ? IconCircleCheck : IconCircleX"
                                     :iconClass="contrato.licenciamentos.length ? 'text-success' : 'text-danger'"
                                     tabName="licenciamento"
                                     @switch-tab="switchTab" class="nav-link active d-flex justify-content-between"
                                     data-bs-toggle="tab"
                                     aria-selected="true" role="tab"/>
                    </li>
                    <li class="nav-item" role="presentation">
                        <NavLinkVoid title="Histórico" :icon="contrato.historico.length ? IconCircleCheck : IconCircleX"
                                     :iconClass="contrato.historico.length ? 'text-success' : 'text-danger'"
                                     tabName="historico"
                                     @switch-tab="switchTab" class="nav-link active d-flex justify-content-between"
                                     data-bs-toggle="tab"
                                     aria-selected="true" role="tab"/>
                    ...
                    <li class="nav-item" role="presentation">
                        <NavLinkVoid title="Anexos" :icon="contrato.anexos.length ? IconCircleCheck : IconCircleX"
                                     :iconClass="contrato.anexos.length ? 'text-success' : 'text-danger'"
                                     tabName="anexo"
                                     @switch-tab="switchTab" class="nav-link active d-flex justify-content-between"
                                     data-bs-toggle="tab"
                                     aria-selected="true" role="tab"/>
