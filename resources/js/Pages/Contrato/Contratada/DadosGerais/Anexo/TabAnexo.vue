...
<template>
    <div class="row mb-4" v-if="can('contratos.contratada.dados_gerais.index')">
            ...
            <tr v-for="anexo in contrato.anexos" :key="anexo.id">
                ...
                <td @click.stop>
                    ...
                    <div class="dropdown-menu dropdown-menu-end" style="">
                        ...
                        <a @click="Object.assign(form, anexo)" class="dropdown-item" href="javascript:void(0)" v-if="can('contratos.contratada.dados_gerais.index')">
                            Editar
                        </a>
                        <a @click="excluirAnexo(anexo.id)" class="dropdown-item" href="javascript:void(0)" v-if="can('contratos.contratada.dados_gerais.index')">
                            Excluir
                        </a>
                    </div>
                </td>
