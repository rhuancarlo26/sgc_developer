...
const espacializarLinha = async () => {
	console.log(form_segmentos.uf_id , form_segmentos.rodovia_id, form_segmentos.km_inicial , form_segmentos.km_final , form_segmentos.tipo_trecho)
		...
		<div class="card-body">
			<div class="row">
				...
				<div class="form-group col">
					...
					<v-select @option:selected="form_segmentos.rodovia_id = null, form_segmentos.tipo_trecho = null" class="w-100"
						id="uf" :options="ufs" label="uf" v-model="form_segmentos.uf_id" :reduce="uf => uf.id">
				...
				<div class="form-group col">
					...
					<input @change="recalculaExtensao" type="number" step="any" min="1" id="km_inicial" name="km_inicial"
						v-model="form_segmentos.km_inicial" class="form-control" />
					<InputError :message="form_segmentos.errors.km_inicial" class="mt-2" />
				</div>
				<!-- KM FINAL  -->
				<div class="form-group col">
					<InputLabel value="Km Final" for="km_final" class="required" />
					<input @change="recalculaExtensao" type="number" id="km_final" name="km_final" step="any" min="1"
				...
				<div class="form-group col">
					...
					<div class="row g-2">
						<div class="col">
							<select name="" id="tipo" class="form-control form-select" v-model="form_segmentos.tipo_trecho">
		...
		<Table :columns="['UF', 'Rodovia', 'KM Inicial', 'KM Final', 'Extensão', 'Tipo', 'Ação']"
			...
			<template #body="{ item }">
				<tr>
					...
					<td class="w-1">
						<div class="d-flex">
							<button @click="zoomTrecho(item?.coordenada)" type="button" class="btn btn-icon btn-primary me-2"
							...
							<button @click="deletarTrecho(item?.idlicenca_br)" type="button" class="btn btn-icon btn-danger">
								<IconTrash />
							</button>
						</div>
					</td>
