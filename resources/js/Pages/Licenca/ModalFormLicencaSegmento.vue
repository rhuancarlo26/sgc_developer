        ...
        <template #body>
            ...
            <div class="row mb-4">
                <div class="col">
                    ...
                    <input @input="calcExtensao()" type="number" step="any" id="km_inicio" name="km_inicio"
                           class="form-control"
                ...
                <div class="col">
                    ...
                    <input @input="calcExtensao()" type="number" step="any" id="km_fim" name="km_fim"
                           class="form-control"
                           v-model="form.km_fim"/>
                ...
                <div class="col">
                    ...
                    <input type="text" id="extensao_br" name="extensao_br" class="form-control"
                           :value="form.extensao_br" disabled
                           readonly/>
