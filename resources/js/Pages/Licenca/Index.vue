                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <div class="dropdown-menu dropdown-menu-end" style="">
                                ...
                                <a v-if="item.arquivo_licenca" class="dropdown-item" target="_blank"
                                    :href="route('licenca.documento.visualizar', item.id)">
                                    Visualizar PDF
                                </a>
                                <NavLink route-name="licenca.condicionante.index" :param="item.id" title="Condicionante"
                                    class="dropdown-item" />
                                ...
                                <NavLinkVoid v-else title="Desarquivar" @click="gerenciarArquivo(item, index, false)"
                                    class="dropdown-item" />
                            </div>
                        </td>
                    </tr>
