                ...
                <div class="card-header">
                    <ul class="nav nav-tabs card-header-tabs" data-bs-toggle="tabs" role="tablist">
                        ...
                        <li v-if="licenca.id" class="nav-item" role="presentation">
                            <a href="#tab-segmento" class="nav-link" data-bs-toggle="tab" aria-selected="false"
                               role="tab">
                                Segmento
                            </a>
                        </li>
                        <!-- TAB - ARQUIVOS -->
                        <li v-if="licenca.id" class="nav-item" role="presentation">
                            <a href="#tab-arquivos" class="nav-link" data-bs-toggle="tab" aria-selected="false"
                               role="tab">
                                Arquivos
                            </a>
                        </li>
                ...
                <div class="card-body">
                    <div class="tab-content">
                        ...
                        <div id="tab-dadosBasicos" class="tab-pane active show" role="tabpanel">
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-4" v-if="form.status != null">
                                    ...
                                    <div class="d-flex">
                                        <input type="text" id="numero_licenca" name="numero_licenca"
                                               class="form-control me-2" v-model="form.numero_licenca"/>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-3">
                                    ...
                                    <input type="text" id="numero_sei" name="numero_sei" class="form-control"
                                           v-model="form.numero_sei"/>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-3">
                                    ...
                                    <input type="date" id="vencimento" name="vencimento" class="form-control"
                                           v-model="form.vencimento" @change="atualizarDatasPrazos"/>
                                ...
                                <div class="col-3">
                                    ...
                                    <input type="text" id="emissor" name="emissor" class="form-control"
                                           v-model="form.emissor"/>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-6">
                                    ...
                                    <input type="text" id="inicio_subtrecho" name="inicio_subtrecho"
                                           class="form-control" v-model="form.inicio_subtrecho"/>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-3">
                                    ...
                                    <input type="text" id="soma_extensao" name="soma_extensao" class="form-control"
                                           v-model="somaExtensao" disabled readonly/>
                                ...
                                <div class="col-3">
                                    ...
                                    <input type="date" id="requerimento" name="requerimento" class="form-control"
                                           v-model="form.requerimento" disabled readonly/>
                                ...
                                <div class="col-3">
                                    ...
                                    <input type="date" id="renovacao" name="renovacao" class="form-control"
                                           v-model="form.renovacao" disabled readonly/>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" id="fiscal" name="fiscal" class="form-control"
                                           v-model="form.fiscal"/>
                            ...
                            <div class="row mb-4" v-if="form.tipo_id == 3">
                                ...
                                <div class="col-2">
                                    ...
                                    <input type="number" id="in_app" name="in_app" class="form-control"
                                           v-model="form.in_app"/>
                                ...
                                <div class="col-2">
                                    ...
                                    <input type="number" id="out_app" name="out_app" class="form-control"
                                           v-model="form.out_app" @change="calcularArea"/>
                                ...
                                <div class="col-2">
                                    ...
                                    <input type="number" id="total_app" name="total_app" class="form-control"
                                           v-model="form.total_app" disabled readonly/>
                                ...
                                <div class="col-4">
                                    ...
                                    <input type="text" id="sinaflor" name="sinaflor" class="form-control"
                                           v-model="form.sinaflor"/>
                            ...
                            <div class="row mb-4">
                                <div class="d-flex justify-content-end">
                                    <a class="btn btn-secondary me-2" href="javascript:void(0);"
                                       @click="voltarPagina()">
                        ...
                        <div id="tab-segmento" class="tab-pane" role="tabpanel">
                            ...
                            <div class="row mb-4">
                                <div class="d-flex justify-content-end">
                                    <a id="botaoAdicionarSegmento" class="btn btn-success" data-bs-toggle="modal"
                                       data-bs-target="#adicionarSegmento" @click="abrirSalvarSegmento()">
                                        <IconPlus class="me-2"/>
                                        Adicionar
                                    </a>
                                </div>
                            ...
                            <Table
                                :columns="titleTableLicencaSegmento"
                                :records="licencaSegmento" table-class="table-hover">
                                <template #body="{ item }">
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a class="btn align-text-top btn-info m-1" data-bs-toggle="modal"
                                               data-bs-target="#adicionarSegmento" title="Editar"
                                               @click="abrirEditarSegmento(item)"
                                               href="javascript:void(0)">
                                                <IconEdit/>

                                            </a>
                                            <a class="btn align-text-top btn-danger m-1" data-bs-toggle="modal"
                                               data-bs-target="#confirmacaoExclusaoSegmento" title="Excluir"
                                               href="javascript:void(0)" @click="dataSegmentoExcluir = item">
                                                <IconTrash/>
                                            </a>
                                        </td>
                                    </tr>
                            ...
                            <!-- MODAL -->
                            <div class="modal fade" id="adicionarSegmento" data-bs-backdrop="static"
                                 data-bs-keyboard="false" tabindex="-1" aria-labelledby="adicionarSegmentoLabel"
                                 aria-hidden="true">
                                <div class="modal-dialog modal-xl">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-4">
                                                    ...
                                                    <select name="rodovia_id" id="rodovia_id" class="form-select"
                                                            v-model="formSegmento.rodovia" @change="resetarUfs()">
                                                        <option :value="null"> -- SELECIONE --</option>
                                                ...
                                                <div class="col-4">
                                                    ...
                                                    <select name="uf_inicial" id="uf_inicial" class="form-select"
                                                            v-model="formSegmento.uf_inicial">
                                                        <option :value="null"> -- SELECIONE --</option>
                                                        <option :value="uf.estado" v-for="uf in brs"
                                                                v-show="uf && uf.rodovia.trim() == formSegmento.rodovia">
                                                            {{ uf.estado }}
                                                        </option>
                                                    </select>
                                                ...
                                                <div class="col-4">
                                                    ...
                                                    <select name="uf_final_id" id="uf_final_id" class="form-select"
                                                            v-model="formSegmento.uf_final">
                                                        <option :value="null"> -- SELECIONE --</option>
                                                        <option :value="uf.estado" v-for="uf in brs"
                                                                v-show="uf && uf.rodovia.trim() == formSegmento.rodovia">
                                                            {{ uf.estado }}
                                            ...
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-4">
                                                    ...
                                                    <input type="text" id="km_inicial" name="km_inicial"
                                                           class="form-control" v-model="formSegmento.km_inicial"
                                                ...
                                                <div class="col-4">
                                                    ...
                                                    <input type="text" id="km_final" name="km_final"
                                                           class="form-control" v-model="formSegmento.km_final"
                                                           @change="calcularExtensao()"/>
                                                ...
                                                <div class="col-4">
                                                    <InputLabel value="Extensão:" for="extensao"/>
                                                    <input type="text" id="extensao" name="extensao"
                                                           class="form-control" v-model="formSegmento.extensao" disabled
                                                           readonly/>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a v-if="!editarLicencaSegmento" class="btn btn-primary"
                                               @click="salvarLicencaSegmento()" href="javascript:void(0);"
                                               data-bs-dismiss="modal">
                                                <IconDeviceFloppy class="me-2"/>
                                                Salvar
                                            </a>
                                            <a v-else class="btn btn-primary" @click="salvarLicencaSegmento()"
                            ...
                            <!-- MODAL EXCLUIR -->
                            <div class="modal fade" id="confirmacaoExclusaoSegmento" tabindex="-1"
                                 aria-labelledby="confirmacaoExclusaoSegmentoLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="confirmacaoExclusaoSegmentoLabel">Confirmação de
                                                Exclusão</h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal"
                        ...
                        <div id="tab-arquivos" class="tab-pane" role="tabpanel">
                            <div v-if="!licenca.documento?.id" class="mb-4">
                                ...
                                <!-- <form @submit="salvarDocumento()"> -->
                                <div class="row g-2">
                                    <div class="col">
                                        <input @input="form_documento.documento = $event.target.files[0]" type="file"
                                               class="form-control">
                                    </div>
                                    <div class="col-auto">
                                        <a @click="salvarDocumento()" href="#" class="btn btn-success"
                                           aria-label="Button" :disabled="form_documento.processing">
                                            Enviar
                                        </a>
                                    </div>
                                </div>
                                <!-- </form> -->
                                <InputError :message="form_documento.errors.extensao"/>
                            </div>
                            <div v-else>
                                <div class="card">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        <a @click="deleteDocumento()" class="dropdown-item"
                                                           href="javascript:void(0)">
                                                            Excluir
                                                        </a>
                                                    </div>
...
const salvarDocumento = () => {
    form_documento.post(route('licenca.documento.store'));
}

const deleteDocumento = () => {
    router.delete(route('licenca.documento.delete', props.licenca.documento.id));
}
