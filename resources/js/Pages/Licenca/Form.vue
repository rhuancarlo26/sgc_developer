                    ...
                    <div class="tab-content">
                        ...
                        <div id="tab-segmento" class="tab-pane" role="tabpanel">
                            ...
                            <table class="table table-striped">
                                <thead>
                                    <tr>
                                        <th class="text-center" scope="col" v-for="column in titleTableLicencaSegmento"
                                            :key="column">
                                            {{ column }}
                                        </th>
                                    </tr>
                                        ...
                                        <td class="text-center" @click.stop>
                                            <span class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end" style="">
                                                    <a class="dropdown-item" @click="abrirEditarSegmento(item)"
                                                        href="javascript:void(0)" data-bs-toggle="modal"
                                                        data-bs-target="#adicionarSegmento">
                                                        Editar
                                                    </a>
                                                    <a class="dropdown-item" href="javascript:void(0)"
                                                        data-bs-toggle="modal"
                                                        data-bs-target="#confirmacaoExclusaoSegmento"
