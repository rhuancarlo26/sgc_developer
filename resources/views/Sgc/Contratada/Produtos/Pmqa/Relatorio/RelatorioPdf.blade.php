...
<div class="full-page-div">
    ...
    <div class="mb-4">
        ...
        <table class="table">
            ...
            <tbody>
                @foreach (($pmqa->rhs ?? collect()) as $item)
                    <tr>
    ...
    <div class="mb-4">
        ...
        <table class="table">
            ...
            <tbody>
                @foreach (($pmqa->veiculos ?? collect()) as $item)
                    <tr>
    ...
    <div class="mb-4">
        ...
        <table class="table">
            ...
            <tbody>
                @foreach (($pmqa->equipamentos ?? collect()) as $item)
                    <tr>
                        <td class="text-center">{{ $item->nome }}</td>
    ...
    <div>
        ...
        <table class="table">
            ...
            <tbody>
                @foreach (($pmqa->licencas_condicionantes ?? collect()) as $item)
                    <tr>
...
<div class="full-page-div">
    ...
    <h3>7.1. Identificação e localização</h3>
    ...
    <h3>7.2. Caracterização e referência</h3>
    <table class="table table-container">
        <thead>
            <tr>
                <th class="text-center">Cod. ponto</th>
...
<div class="full-page-div">
    ...
    <div>
        <div class="mb-4">
            <h3>8.1. Identificação dos parâmetros</h3>
            <table class="table table-container">
                <thead>
                    <tr>
        ...
        <div class="mb-4">
            <h3>8.2. Limites - resoluções CONAMA N° 357/2005</h3>
            <table class="table table-container">
                <thead>
                    <tr>
                        <th>Parâmetro</th>
...
<div class="full-page-div">
    ...
    @if (count($analises))
        @foreach ($parametrosVinculados as $key => $item)
            @if (isset($analises[$item->id]))
                <div class="mb-4">
                    <h3>10.{{ $key + 2 }}. {{ $item->nome }}</h3>
                    @if ($analises[$item->id]->imagem)
                        <img class="full-page-image" src="{{ $analises[$item->id]->imagem }}" alt="Gráfico">
                    @endif
                    <div>
                        <span><strong>Análise: </strong>{{ $analises[$item->id]->analise_parametro }}</span>
                    </div>
                </div>
            @endif
        @endforeach
