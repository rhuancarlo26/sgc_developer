...
Route::delete('{contrato}/{servico}/delete/{ocorrencia}',         [DeleteController::class, 'index'])->name('contratos.contratada.servicos.cont_ocorrencia.execucao.ocorrencia.delete');
