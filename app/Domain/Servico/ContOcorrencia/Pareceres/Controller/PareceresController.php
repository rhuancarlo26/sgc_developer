...
namespace App\Domain\Servico\ContOcorrencia\Pareceres\Controller;

use App\Domain\Servico\ContOcorrencia\Pareceres\Service\PareceresService;
...
class PareceresController extends Controller
{
    ...
    public function index(Contrato $contrato, Servicos $servico)
    {
        ...
        return Inertia::render('Servico/ContOcorr/Pareceres/Pareceres', [
            'contrato'  => $contrato,
