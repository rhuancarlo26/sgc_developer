...
namespace App\Domain\Servico\ContOcorrencia\Pareceres\Service;
...
{
    public function __construct(private readonly ServicoContOcorrSupervisaoParecerConfiguracao $ServicoContOcorrSupervisaoParecerConfiguracao) {}

    public function getPareceres($id_servico)
    {
        $configuracoes = $this->ServicoContOcorrSupervisaoParecerConfiguracao  ::select(
        ...
        $relatorios = ServicoConOcorrSupervisaoRelatorio::select(
