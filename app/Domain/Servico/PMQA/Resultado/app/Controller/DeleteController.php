...
class DeleteController extends Controller
{
  ...
  public function index(Contrato $contrato, Servicos $servico, ServicoPmqaResultado $resultado): RedirectResponse
  {
    $response = $this->resultadoService->destroy(resultado: $resultado);
