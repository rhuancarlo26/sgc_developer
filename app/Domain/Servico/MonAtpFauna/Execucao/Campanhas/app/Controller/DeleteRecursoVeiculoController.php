...
class DeleteRecursoVeiculoController extends Controller
{
  ...
  {
    $response = $this->campanhasService->delete_veiculo(post: $request->all());

    return response()->json([
      'data' => $this->execucaoCampanhaService->getRelationshipCampanha($request->veiculo['at_fauna_execucao_campanha_id']),
