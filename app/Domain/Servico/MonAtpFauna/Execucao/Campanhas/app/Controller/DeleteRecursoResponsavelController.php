...
class DeleteRecursoResponsavelController extends Controller
{
  ...
  {
    $response = $this->campanhasService->delete_responsavel(post: $request->all());
    return response()->json([
      'data' => $this->execucaoCampanhaService->getRelationshipCampanha($request->responsavel['at_fauna_execucao_campanha_id']),
