...
class DeleteRecursoEquipamentoController extends Controller
{
  ...
  {
    $response = $this->campanhasService->delete_equipamento(post: $request->all());

    return response()->json([
      'data' => $this->execucaoCampanhaService->getRelationshipCampanha($request->equipamento['at_fauna_execucao_campanha_id']),
