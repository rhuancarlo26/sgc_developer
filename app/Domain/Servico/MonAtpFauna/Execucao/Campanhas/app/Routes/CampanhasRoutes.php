...
use App\Domain\Servico\MonAtpFauna\Execucao\Campanhas\app\Controller\DeleteRecursoEquipamentoController;
use App\Domain\Servico\MonAtpFauna\Execucao\Campanhas\app\Controller\DeleteRecursoEquipeController;
...
use App\Domain\Servico\MonAtpFauna\Execucao\Campanhas\app\Controller\StoreRecursoResponsavelController;
use App\Domain\Servico\MonAtpFauna\Execucao\Campanhas\app\Controller\StoreRecursoVeiculoController;
...
Route::get('get-relationship', GetRelationshipController::class)->name('contratos.contratada.servicos.mon_atp_fauna.execucao.campanhas.get-relationship');
...
Route::post('store_responsavel', [StoreRecursoResponsavelController::class, 'index'])->name('contratos.contratada.servicos.mon_atp_fauna.execucao.campanhas.store_responsavel');
Route::post('store_equipe', [StoreRecursoEquipeController::class, 'index'])->name('contratos.contratada.servicos.mon_atp_fauna.execucao.campanhas.store_equipe');
Route::post('store_equipamento', [StoreRecursoEquipamentoController::class, 'index'])->name('contratos.contratada.servicos.mon_atp_fauna.execucao.campanhas.store_equipamento');
Route::post('store_veiculo', [StoreRecursoVeiculoController::class, 'index'])->name('contratos.contratada.servicos.mon_atp_fauna.execucao.campanhas.store_veiculo');
Route::post('delete_responsavel', [DeleteRecursoResponsavelController::class, 'index'])->name('contratos.contratada.servicos.mon_atp_fauna.execucao.campanhas.delete_responsavel');
