...
use App\Domain\Servico\MonAtpFauna\Relatorios\app\Controller\UpdateController;
...
Route::patch('/update', UpdateController::class)->name('contratos.contratada.servicos.mon_atp_fauna.relatorios.update');
