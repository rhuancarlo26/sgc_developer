...
class StoreController extends Controller
{
	...
	{
		$response = $this->moduloAmostralService->store($request->validated());

		return to_route('contratos.contratada.servicos.monitora_fauna.configuracoes.modulo_amostral.index', [
