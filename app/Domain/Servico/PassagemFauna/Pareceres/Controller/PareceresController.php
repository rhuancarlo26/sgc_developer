...
namespace App\Domain\Servico\PassagemFauna\Pareceres\Controller;

use App\Domain\Servico\PassagemFauna\Pareceres\Service\PareceresService;
...
class PareceresController extends Controller
{
    ...
    public function index(Contrato $contrato, Servicos $servico)
    {
        ...
        return Inertia::render('Servico/PassagemFauna/Pareceres/Pareceres', [
            'contrato'  => $contrato,
