...
class UpdateOutraAnaliseController extends Controller
{
    ...
    public function index(Contrato $contrato, Servicos $servico, ServicoPassagemFaunaResultado $resultado, Request $request)
    {
        $response = $this->resultadoService->updateOutraAnalise(post: $request->all());
