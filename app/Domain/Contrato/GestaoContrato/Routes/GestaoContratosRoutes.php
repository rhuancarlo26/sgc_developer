...
use App\Domain\Contrato\GestaoContrato\Controller\EspacializarLinhaContratoTrechoController;
...
Route::prefix('gestao')->group(function () {
    ...
    Route::post('/storeTrecho/getTipoPorUfBr', [GetTipoPorUfBrContratoTrechoController::class, 'getTipoPorUfBr'])->name('contratos.gestao.getTipoPorUfBr_trecho');
    Route::post('/storeTrecho/espacializarLinha', [EspacializarLinhaContratoTrechoController::class, 'espacializarLinha'])->name('contratos.gestao.espacializarLinha_trecho');
