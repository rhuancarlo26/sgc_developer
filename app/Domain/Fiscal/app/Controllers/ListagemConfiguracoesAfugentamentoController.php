...
class ListagemConfiguracoesAfugentamentoController extends Controller
{
    ...
    public function index(Contrato $contrato, Request $request): Response
    {
        ...
        $response = $this->servicoService->listagemConfiguracao(contrato: $contrato, searchParams: $searchParams, id_servico: 2);

        return Inertia::render('Fiscal/Configuracao/TabConfiguracoesAfugentamento', [
            'contrato' => $contrato,
            ...$response
        ]);
    }
