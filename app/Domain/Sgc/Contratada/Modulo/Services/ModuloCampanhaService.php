...
namespace App\Domain\Sgc\Contratada\Modulo\Services;
...
class ModuloCampanhaService
{
    public function store(array $data): SgcModuloCampanha
    {
        ...
        $campanha = SgcModuloCampanha::create($data);

        try {
            $this->gerenciarFotos($campanha, $fotos);
            $this->gerenciarAnexos($campanha, $anexos);

            return $campanha;
        } catch (\Throwable $e) {
            $campanha->fotos()->delete();
    ...
    private function gerenciarFotos(SgcModuloCampanha $campanha, array $fotos): void
    {
        $idsFotos = [];
    ...
    private function gerenciarAnexos(SgcModuloCampanha $campanha, array $anexos): void
    {
        $idsAnexos = [];
