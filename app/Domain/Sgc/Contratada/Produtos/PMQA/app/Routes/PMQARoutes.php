...
Route::prefix('/pmqa')->group(function () {
    Route::prefix('/configuracao')->group(function () {
        Route::post('{campanha}/envia-fiscal-pmqa', [EnviaFiscalController::class, 'index'])
            ->name('contratos.contratada.servicos.pmqa.configuracao.envia-fiscal-pmqa');
        Route::get('{campanha}/aprovacao-config-pmqa', [AprovacaoConfigController::class, 'index'])->name('aprovacao-config-pmqa.get');
