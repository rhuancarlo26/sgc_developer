...
class EspeleoCampanhaController extends Controller
{
    ...
    public function approve(Request $request, $contrato, $produto, $campanhaId)
    {
        ...
        if ($validated['status'] === 'Rejeitada' && empty(trim((string) ($validated['observacoes'] ?? '')))) {
